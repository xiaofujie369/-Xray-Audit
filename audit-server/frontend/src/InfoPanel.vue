...
const text: Record<string,string> = {suspected:'疑似屏蔽',confirmed:'确认屏蔽',recovered:'已恢复',manual:'手动',probe:'探测',false_positive:'误报',same_hour_previous_7_days:'前 7 天同时间段',previous_24h_excluding_incidents:'前 24 小时（排除事件窗口）',user:'用户',domain:'域名',source_ip:'来源 IP',destination_ip:'目标 IP'}
